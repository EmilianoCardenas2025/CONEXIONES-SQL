...
namespace tienda {
    ...
    public partial class TiendaDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public ClientesRow AddClientesRow(int IdCliente, string Nombre, string Apellido, int Edad) {
...
namespace tienda.TiendaDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([IdCliente] = @Original_IdCliente) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Edad = 1 AND [Edad] IS NULL) OR ([Edad] = @Original_Edad)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([IdCliente], [Nombre], [Apellido], [Edad]) VALUES (" +
                "@IdCliente, @Nombre, @Apellido, @Edad);\r\nSELECT IdCliente, Nombre, Apellido, Eda" +
                "d FROM Clientes WHERE (IdCliente = @IdCliente)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [IdCliente] = @IdCliente, [Nombre] = @Nombre, [Apellido] = @Apellido, [Edad] = @Edad WHERE (([IdCliente] = @Original_IdCliente) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Edad = 1 AND [Edad] IS NULL) OR ([Edad] = @Original_Edad)));
SELECT IdCliente, Nombre, Apellido, Edad FROM Clientes WHERE (IdCliente = @IdCliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdCliente, Nombre, Apellido, Edad FROM dbo.Clientes";
        ...
        public virtual int Delete(int Original_IdCliente, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_Edad) {
        ...
        public virtual int Insert(int IdCliente, string Nombre, string Apellido, global::System.Nullable<int> Edad) {
        ...
        public virtual int Update(int IdCliente, string Nombre, string Apellido, global::System.Nullable<int> Edad, int Original_IdCliente, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_Edad) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, global::System.Nullable<int> Edad, int Original_IdCliente, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_Edad) {
            return this.Update(Original_IdCliente, Nombre, Apellido, Edad, Original_IdCliente, Original_Nombre, Original_Apellido, Original_Edad);
        }
    }
